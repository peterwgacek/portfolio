        ...
        <Carousel
            ...
            <>
                ...
                <div className="myCarousel">
                    ...
                    <a href="https://github.com/curiositysquad/frontend" target='_blank'><i class="fab fa-github-square"></i></a>
                    <a href="https://morementum.herokuapp.com/" target='_blank'><i class="fas fa-link"></i></a>
                </div>
            </>
            <>
                ...
                <div className="myCarousel">
                    ...
                    <a href="https://thereduxcloneofmonkeyislandtm.herokuapp.com/" target='_blank'><i class="fas fa-link"></i></a>
                </div>
            </>
            <>
                ...
                <div className="myCarousel">
                    ...
                    <a href="https://marvel-assemble.herokuapp.com/" target='_blank'><i class="fas fa-link"></i></a>
                </div>
            </>
            <>
                ...
                <div className="myCarousel">
                    ...
                    <a href="https://vo-go.herokuapp.com/" target='_blank'><i class="fas fa-link"></i></a>
                </div>
            </>
            <>
                ...
                <div className="myCarousel">
                    ...
                    <a href="https://genre-smash.vercel.app/" target='_blank'><i class="fas fa-link"></i></a>
                </div>
            </>
